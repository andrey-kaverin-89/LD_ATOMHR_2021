  ...
  return (
    <QueryBuilder
      ...
      render={({
        ...
        if (chartType != vizState.chartType) updateChartType(vizState.chartType)
        return (
          <Fragment>
            <Row
              type="flex"
                ...
                <Card>
                  ...
                  >
                    <Col span={24}>
                      <FilterGroup
                        ...
                        // updateMethods={{...updateFilters, update: (f,s) => { 
                        //   updateFilters.update(f,s); 
                        //   console.log(f)
                        //   // updateChartType(vizState.chartType)
                        // }}}
                      />
                    </Col>
                  </Row>
                  ...
                  >
                    <Col span={24}>
                      ...
                      />
                      {/* chartType {JSON.stringify(chartType)} */}
                      {/* vizState {JSON.stringify(vizState.chartType)} */}

                      <br />
                      filters {JSON.stringify(filters)}
                      <br />
                      <br />
                      vizState {JSON.stringify(vizState?.query?.filters)}
                      <br />
